...
##################################################################
# experiment folders
EXPERIMENT_NAME="experiments/DIRECT-LOG-CLUSTERING"
...
# Build DECLARE-Tree
echo "################################ DECLARE TREES"
python3 -m DeclareTrees.trees_for_logs $OUTPUT_CHECK_CSV $CONSTRAINTS_THRESHOLD $PROCESSED_OUTPUT_CHECK_CSV $RESULT_TREE $BRANCHING_POLICY $MINIMIZATION_FLAG
