...
##################################################################
# experiment folders
EXPERIMENT_NAME="experiments/PLAYGROUND"
...
# Build DECLARE-Tree
echo "################################ DECLARE TREES"
python3 -m DeclareTrees.trees_for_clusters $PROCESSED_DATA_FOLDER"/aggregated_result.csv" 0.8 $RESULTS_FOLDER"/DeclareTree.dot" "dynamic" "True"
