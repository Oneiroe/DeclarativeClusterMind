...
#python3 -m DeclarativeClusterMind.utils.split_log_according_to_declare_model $INPUT_LOG $OUTPUT_TRACE_MEASURES_CSV $SPLIT_THRESHOLD $LOG_80_FIT $LOG_20_DIVERGENT
